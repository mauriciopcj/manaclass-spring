...
import br.edu.ifpb.pweb2.caderneta.dao.IGenericDAO;
import br.edu.ifpb.pweb2.caderneta.spring.controller.AlunoController;


@Configuration
@EnableWebMvc
@ComponentScan(basePackageClasses = { AlunoController.class,  
		IGenericDAO.class, AlunoService.class, Aluno.class})
